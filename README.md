...
2. Install Arduino IDE
    ...
    * When you run the software, it should look something like this (arduino-morse-code-001.jpg)[https://github.com/richardjoo/arduino-morse-code/blob/master/pictures/arduino-morse-code-001.jpg]
...
5. Assemble LED blinking kit
    ...
    * If it is the same tutorial file, then the file name should be Arduino Stater Kit Tutorals 100-104 and diagram can be found on page 11. And here is the screen shot of it. (arduino-morse-code-002.jpg)[https://github.com/richardjoo/arduino-morse-code/blob/master/pictures/arduino-morse-code-002.jpg]
6. Open morsecode.ino from one of these three folders (basic, enhanced, and advanced)
    * it should be looking like this (arduino-morse-code-003.jpg)[https://github.com/richardjoo/arduino-morse-code/blob/master/pictures/arduino-morse-code-003.jpg]
